...
return [
    ...
    */
    ...
    |
    | Supported: "smtp", "smtp", "sendmail", "mailgun", "log",
    |            "ses", "postmark", "array", "failover"
    |
    */
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | If you are using Markdown based email templates, you may configure
    | the theme and component paths here, allowing you to customize the
    | look and feel of the emails. Or, you may simply stick with the
    | Laravel defaults!
    |
    */
