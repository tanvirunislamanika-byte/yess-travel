        ...
        if ($request->hasFile('image')) {
            if(null!==($request->images_limit) && $request->images_limit > 1){
                ...
                foreach($files as $file){
                    $image = $file;
                    $width = $request->width?$request->width:120;
                    $height = $request->height?$request->height:120;
               ...
               $image = $request->file('image');
                ...
                $destinationPath = public_path('/images/thumb');
                if($extension !=='ico' && $extension !=='pdf' && $extension !=='doc' && $extension !=='docx' && $extension !=='svg' && $extension !=='mp4'){
