                                ...
                                <div class="col-sm-4">
                                    <div class="service vertical text-left wow fadeInUp animated" style="visibility: visible; animation-name: fadeInUp;">
                                        ...
                                        <div class="service-content service wow fadeInUp animated" style="visibility: visible; animation-name: fadeInUp;">
                                            <h3 class="service-title title service wow fadeInUp greenBG animated" style="visibility: visible; animation-name: fadeInUp;">{{$service->getTranslatedTitle()}}</h3>
                                            <p>
                                                {{$service->getTranslatedExtraField(1)}}
                                            </p>
                                            <p>
                                                <a href="{{route('services.detail',$service->slug)}}" alt="{{$service->getTranslatedExtraField(2)}}" class="btn btn-success btn-sm active" target="_blank" title="{{$service->getTranslatedExtraField(2)}}">{{$service->getTranslatedExtraField(2)}}</a>
                                            </p>
