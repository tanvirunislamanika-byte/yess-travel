<x-admin-layout>
    ...
    <input type="hidden" id="is_preview" name="is_preview" value="{{ $module->is_preview ? 'no' : 'no' }}">
    ...
    <input type="hidden" id="modules_data_fetch" name="modules_data_fetch" value="{{ route('modules.data.fetch') }}">
    ...
    @push('js')
        <script src="{{ asset('js/modules.js?v=4.2') }}"></script>
        <script>
