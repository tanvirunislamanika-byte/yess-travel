...
<div class="row">
    <div class="col-md-12" style="{{$style}}">
        <div class="mb-3">
            ...
            {!! Form::text('title', isset($titleVal)?$titleVal:null, array('class'=>'form-control', 'id'=>'title','readonly'=>'readonly', 'placeholder'=>$module->term, 'required'=>'required')) !!}
        </div>
    </div>
    ...
    <div class="col-md-12">
        <div class="mb-3">
            {!! Form::label('description', ' Notes', ['class' => '']) !!}
            {!! Form::textarea('description', $html, array('class'=>'form-control editor1', 'id'=>'editor1', 'placeholder'=>$module->term.' Note', 'required'=>'required')) !!}
        </div>
    </div>
    @endif
    ...
    @if(isset($fieldsss[0]) && isset($fieldsss[1]) && isset($fieldsss[2]))
     ...
     $(document).ready(function () {
        ...
        $('#{{$fieldsss[2]}}').change(function() {
          ...
          $.ajax({
            url: "{{url('/filter-parties')}}/"+selectedValue, // Replace with your actual URL
