<x-admin-layout>   
    <div class="container-xl px-4">
        ...
        <div class="card mb-4">
            <livewire:admin.common.header :title="'Update '.$module->term" :content="'Please fill all the fields to update '.$module->term" :icon="'fa-school'" :term="$module->term" :slug="url('/'.$module->slug)" :button="__($module->name.' List')"/>
            <div class="card-body">
               ...
               {!! Form::model($module_data, array('method' => 'post', 'route' => array('modules.data.update',$module->slug), 'class' => 'form', 'files'=>true,'novalidate'=>'novalidate')) !!}
