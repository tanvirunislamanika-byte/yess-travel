   ...
   <div class="row">
      <div class="col-md-12">
         <div class="mb-3">
            {!! Form::label('title', 'Widget Title', ['class' => '']) !!}
   ...
   <div class="row">
     <div class="col-md-12">
        <div class="mb-3">
            {!! Form::label('widget_page_id', 'Widget Page', ['class' => '']) !!}
      ...
      <div class="col-md-12">
        <div class="mb-3">
          @php
            ...
            @endphp
            {!! Form::label('is_description', 'Widget Description', ['class' => '']) !!}
   ...
   <div class="row">
      <div class="col-md-12">
        <div class="mb-3">
            {!! Form::label('is_extra_image_title_1', 'Widget Image 1', ['class' => '']) !!}
   ...
   <div class="row">
      <div class="col-md-12">
        <div class="mb-3">
            {!! Form::label('is_extra_image_title_2', 'Widget Image 2', ['class' => '']) !!}
   ...
   <div class="row">
      ...
      <div class="col-md-12 extra_field_title" style="display: none;">
         <div class="mb-3">
            {!! Form::label('extra_field_title_7', 'Extra Field Title 7', ['class' => '']) !!}
      ...
      <div class="col-md-12 extra_field_title" style="display: none;">
         <div class="mb-3">
            {!! Form::label('extra_field_title_8', 'Extra Field Title 8', ['class' => '']) !!}
      ...
      <div class="col-md-12 extra_field_title" style="display: none;">
         <div class="mb-3">
            {!! Form::label('extra_field_title_9', 'Extra Field Title 9', ['class' => '']) !!}
      ...
      <div class="col-md-12 extra_field_title" style="display: none;">
         <div class="mb-3">
            {!! Form::label('extra_field_title_10', 'Extra Field Title 10', ['class' => '']) !!}
      ...
      <div class="col-md-12 extra_field_title" style="display: none;">
         <div class="mb-3">
            {!! Form::label('extra_field_title_11', 'Extra Field Title 11', ['class' => '']) !!}
      ...
      <div class="col-md-12 extra_field_title" style="display: none;">
         <div class="mb-3">
            {!! Form::label('extra_field_title_12', 'Extra Field Title 12', ['class' => '']) !!}
      ...
      <div class="col-md-12 extra_field_title" style="display: none;">
         <div class="mb-3">
            {!! Form::label('extra_field_title_13', 'Extra Field Title 13', ['class' => '']) !!}
      ...
      <div class="col-md-12 extra_field_title" style="display: none;">
         <div class="mb-3">
            {!! Form::label('extra_field_title_14', 'Extra Field Title 14', ['class' => '']) !!}
      ...
      <div class="col-md-12 extra_field_title" style="display: none;">
         <div class="mb-3">
            {!! Form::label('extra_field_title_15', 'Extra Field Title 15', ['class' => '']) !!}
      ...
      <div class="col-md-12 extra_field_title" style="display: none;">
         <div class="mb-3">
            {!! Form::label('extra_field_title_16', 'Extra Field Title 16', ['class' => '']) !!}
            {!! Form::text('extra_field_title_16', null, array('class'=>'form-control', 'id'=>'extra_field_title_16', 'placeholder'=>'Extra Field Title 16')) !!}
         </div>
      </div>

      <div class="col-md-12 extra_field_title" style="display: none;">
         <div class="mb-3">
            {!! Form::label('extra_field_title_17', 'Extra Field Title 17', ['class' => '']) !!}
            {!! Form::text('extra_field_title_17', null, array('class'=>'form-control', 'id'=>'extra_field_title_17', 'placeholder'=>'Extra Field Title 17')) !!}
         </div>
      </div>

      <div class="col-md-12 extra_field_title" style="display: none;">
         <div class="mb-3">
            {!! Form::label('extra_field_title_18', 'Extra Field Title 18', ['class' => '']) !!}
            {!! Form::text('extra_field_title_18', null, array('class'=>'form-control', 'id'=>'extra_field_title_18', 'placeholder'=>'Extra Field Title 18')) !!}
         </div>
      </div>

      <div class="col-md-12 extra_field_title" style="display: none;">
         <div class="mb-3">
            {!! Form::label('extra_field_title_19', 'Extra Field Title 19', ['class' => '']) !!}
            {!! Form::text('extra_field_title_19', null, array('class'=>'form-control', 'id'=>'extra_field_title_19', 'placeholder'=>'Extra Field Title 19')) !!}
         </div>
      </div>
      ...
      <div class="col-md-12">
         <div class="mb-3">
            ...
            @endphp
            {!! Form::label('radio_buttons', 'Radio Buttons', ['class' => '']) !!}
      ...
      <div class="col-md-12 extra_button_title" style="display: none;">
         <div class="mb-3">
            {!! Form::label('radio_button_title_3', 'Radio Button Title 3', ['class' => '']) !!}
