        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">Edit City: {{ $city->name }}</h5>
                    ...
                    <form action="{{ route('admin.cities.update', $city->id) }}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('country_id') is-invalid @enderror" 
                                        ...
                                        @foreach($countries as $id => $name)
                                            <option value="{{ $id }}" {{ old('country_id', $city->country_id) == $id ? 'selected' : '' }}>
                                                {{ $name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" step="any" class="form-control @error('latitude') is-invalid @enderror" 
                                           id="latitude" name="latitude" value="{{ old('latitude', $city->latitude) }}" 
                                           min="-90" max="90">
                                    @error('latitude')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" step="any" class="form-control @error('longitude') is-invalid @enderror" 
                                           id="longitude" name="longitude" value="{{ old('longitude', $city->longitude) }}" 
                                           min="-180" max="180">
                                    @error('longitude')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                        ...
                        <div class="text-end">
                            <button type="submit" class="btn btn-primary">
                                <i data-feather="save"></i> Update City
                            </button>
                        </div>
                    </form>
                </div>
