...
(function() {
        ...
        if (b && b.data("cke-saved-href")) {
            ...
            if (e) {
                var f = "function" == typeof e.defaults ? e.defaults() : e.defaults,
                    ...
                    h, m = a.widgets.wrapElement(f, e.name),
    ...
    CKEDITOR.plugins.add("autoembed", {
        ...
        lang: "az,ca,cs,de,de-ch,en,eo,es,eu,fr,it,km,ko,ku,mk,nb,nl,oc,pl,pt,pt-br,ru,sk,sv,tr,ug,uk,zh,zh-cn",
        init: function(a) {
            var g =
                1,
                b;
