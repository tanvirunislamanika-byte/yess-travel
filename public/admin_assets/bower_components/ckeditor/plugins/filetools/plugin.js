...
(function() {
    ...
    CKEDITOR.plugins.add("filetools", {
        lang: "az,ca,cs,da,de,de-ch,en,eo,es,eu,fr,gl,id,it,ja,km,ko,ku,nb,nl,oc,pl,pt,pt-br,ru,sv,tr,ug,uk,zh,zh-cn",
        beforeInit: function(a) {
            a.uploadRepository = new h(a);
            a.on("fileUploadRequest",
                function(a) {
    ...
    k.prototype = {
        ...
        attachRequestListeners: function() {
            ...
            c.onload = function() {
                b.update();
                if ("abort" != b.status)
                    if (b.uploaded = b.uploadTotal, 200 > c.status || 299 < c.status) b.message = b.lang.filetools["httpError" +
                        c.status], b.message || (b.message = b.lang.filetools.httpError.replace("%1", c.status)), b.changeStatus("error");
                    else {
                        for (var a = {
                                fileLoader: b
    ...
    CKEDITOR.tools.extend(CKEDITOR.fileTools, {
        ...
        getUploadUrl: function(a, d) {
            ...
            return d && a[d + "UploadUrl"] ? a[d + "UploadUrl"] : a.uploadUrl ? a.uploadUrl :
                d && a["filebrowser" + b(d, 1) + "UploadUrl"] ? a["filebrowser" + b(d, 1) + "UploadUrl"] + "\x26responseType\x3djson" : a.filebrowserUploadUrl ? a.filebrowserUploadUrl + "\x26responseType\x3djson" : null
        },
